...
import '../components/css/detallesreportesVendedor.css';
...
class DetallesReportesVendedor extends React.Component {
        ...
        return (
            <div>
                <Loading active={this.state.loading}/>
                 <div> 
                     <NewMenu/>
                     <Container fluid={true} id="body_DetallesReportesVendedor">
                     <Titulo titulo="VENDEDOR INGRESOS Y COMISIONES"/>
                        <Container>
                              <Row className="pt-3">
...
export default DetallesReportesVendedor;